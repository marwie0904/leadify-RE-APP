...
export function InviteMemberModal({ open, onOpenChange, onSuccess, getAuthHeaders, organizationId }: InviteMemberModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("[InviteMemberModal] Sending invitation to:", formData.email, "with role:", formData.role, "for organization:", organizationId)
