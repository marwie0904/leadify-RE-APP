...
export function useCreateAgent() {
  ...
  return useMutation({
    mutationFn: async (data: CreateAgentData) => {
      ...
      // Migration note: This will automatically migrate to POST /api/v1/agents when feature flag enabled
...
export function useUpdateAgent() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const headers = await getAuthHeaders()
      // Migration note: This will automatically migrate to PUT /api/v1/agents/{agentId} when feature flag enabled
...
export function useDeleteAgent() {
  ...
  return useMutation({
    mutationFn: async (agentId: string) => {
      const headers = await getAuthHeaders()
      // Migration note: This will automatically migrate to DELETE /api/v1/agents/{agentId} when feature flag enabled
