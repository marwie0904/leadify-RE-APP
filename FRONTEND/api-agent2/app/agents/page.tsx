...
export default function AgentsPage() {
  ...
  const fetchAgents = async () => {
    try {
      ...
      // Migration note: /api/agents automatically migrates to /api/v1/agents when feature flag enabled
  ...
  const handleCreateAgent = async (agentData: {
    ...
    try {
      ...
      // Migration note: /api/agents/create automatically migrates to POST /api/v1/agents when feature flag enabled
      console.log("Making API call to /api/agents/create (migrates to POST /api/v1/agents)...")
