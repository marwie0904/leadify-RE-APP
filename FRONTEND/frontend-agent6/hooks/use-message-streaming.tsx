...
import type { Message } from "@/types/human-in-loop"
...
export function useMessageStreaming({ 
    ...
    pollingIntervalRef.current = setInterval(async () => {
      try {
        const url = lastMessageIdRef.current 
          ? `${API_BASE_URL}/api/messages/${conversationId}?lastMessageId=${lastMessageIdRef.current}`
  ...
  const startSSE = useCallback(() => {
    ...
    try {
      ...
      const sseUrl = `${API_BASE_URL}/api/messages/${conversationId}/stream`
