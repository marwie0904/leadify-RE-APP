...
import type { ConversationMode, Conversation } from "@/types/human-in-loop"
...
export function getConversationMode(conversation: Partial<Conversation>): ConversationMode {
...
export function getHumanAgentName(conversation: Partial<Conversation>): string | undefined {
