...
export function HandoffRequestButton({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Use migrated endpoint for handoff request
      const endpoint = shouldUseMigratedEndpoint()
        ? `/api/v1/conversations/${conversationId}/handoff`
        : `/api/conversations/${conversationId}/request-handoff`
      ...
      setRequested(true)
      toast.success("Human agent requested successfully")
      ...
      console.error('[HandoffRequest] Error:', err)
