...
export default function LeadsPage() {
  ...
  const leadStats = {
    ...
    newLeads: displayedLeads.filter(lead => lead.classification === 'cold' || lead.status === 'new').length,
    qualifiedLeads: displayedLeads.filter(lead => lead.classification === 'hot' || lead.status === 'qualified').length,
    avgBANTScore: displayedLeads.reduce((sum, lead) => {
      return sum + (lead.bantScore?.totalScore || 0)
    }, 0) / Math.max(displayedLeads.length, 1)
  }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage and qualify your sales leads with BANT scoring
          </p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-2xl font-bold text-green-600">{leadStats.qualifiedLeads}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="space-y-1">
                <p className="text-sm font-medium text-muted-foreground">Avg BANT Score</p>
                <p className="text-2xl font-bold">{Math.round(leadStats.avgBANTScore)}/100</p>
              </div>
            </div>
          </CardContent>
        </Card>
